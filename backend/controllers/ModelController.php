...
class ModelController extends Controller
{
    ...
    public function behaviors()
    {
        return [
            ...
            'access' => [
                ...
                'rules' => [
                    [
                        'actions' => ['index', 'view', 'update', 'delete', 'create', 'assign-to-make', 'get-model-by-make'],
                        'allow' => true,
                        'roles' => ['Admin']
                    ]
                ]
    ...
    /* other process */
    public function actionAssignToMake() /* ajax */
    {
        $model = new MakeHasModel();
        if($model->load(Yii::$app->request->post()) && $model->save()) echo 'success';
        else echo 'fail';
    }

    public function actionGetModelByMake() /* ajax */
    {
        $makeId = Yii::$app->request->post('makeId');
