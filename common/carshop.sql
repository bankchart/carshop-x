...
--
-- Host: localhost
-- Generation Time: Nov 11, 2016 at 07:08 AM
...
INSERT INTO `car_type` (`sub_category_id`, `category_id`, `car_id`) VALUES
(6, 1, 3),
(7, 1, 1),
(8, 2, 1),
(8, 2, 5),
...
--
-- Table structure for table `category_has_sub_category`
--
...
--
-- Dumping data for table `category_has_sub_category`
--

INSERT INTO `category_has_sub_category` (`category_id`, `sub_category_id`) VALUES
(1, 1),
(1, 2),
(1, 4),
(1, 5),
...
(2, '<p>Where do I download the file to?</p>\r\n', '<p>We recommend that you download the file to your Desktop, so it is easy to find to initiate the installation. You can download the file anywhere you like, just make sure that you remember the location where you saved it, and the name of the file. Do not rename the file that you are downloading; it may cause installation problems.</p>\r\n'),
(3, '<p>Where do I find my Office product key?</p>\r\n', '<p>Your product key is 25 characters and is found in different locations depending on how you acquired your Office product.</p>\r\n\r\n<ul>\r\n	<li>If you purchased Office on a traditional disc the product key should be located inside the package on a label on the card opposite the disc holder on the left side of the DVD case.</li>\r\n	<li>If you purchased an Office product key card the product key should be located inside the package on a label on the left side of the case.</li>\r\n	<li>If the product key is not inside the package, please review the instructions in the package.</li>\r\n	<li>If you purchased and downloaded Office online the product key should be on the confirmation page and/or email that was sent to you when you downloaded the software.</li>\r\n	<li>If you purchased a new computer with Office preloaded the manufacturer of your computer should have included either media or a Microsoft Product Identifier card in the box that has the product key. The product key is located on the Certificate of Authenticity.</li>\r\n	<li>If you need additional help locating your product key, please refer to these resources:\r\n	<ul>\r\n		<li><a href="https://support.office.com/en-US/article/Find-your-product-key-for-Office-2007-fabe03d9-fbc3-452e-8fd4-d1c2e661d518" target="_blank">Office 2007</a></li>\r\n		<li><a href="https://support.office.com/en-us/article/Find-your-product-key-for-Office-2010-1e8ef39c-2bd4-4581-a0ae-5cf25ebed489?ui=en-US&amp;rs=en-US&amp;ad=US" target="_blank">Office 2010</a></li>\r\n		<li><a href="https://support.office.com/en-US/article/Find-your-product-key-for-Office-for-Mac-2011-670b19d6-7743-45ae-a53c-66080cec7e33" target="_blank">Office for Mac 2011</a></li>\r\n	</ul>\r\n	</li>\r\n</ul>\r\n');
...
INSERT INTO `slides` (`id`, `car_id`, `photo`, `caption`, `created_at`, `updated_at`, `created_by`, `updated_by`) VALUES
(1, 5, 'a3af86b20c994156a5fc838eaad4136b.jpg', '<h2><strong>2016 Honda CR-V 2.4 i-VTEC Merdeka Bonus up to RM6000</strong></h2>\r\n\r\n<p><small>Honda CR-V, 2354 cc, Automatic</small></p>\r\n', 1478064427, 1478238174, 1, 1),
(2, 8, 'ddea9d4c9373936449fb6b7e5f52a4dc.jpg', '<h2><strong>2012 Mercedes Benz C200 1.8 CGI</strong></h2>\r\n\r\n<p><small>Mercedes-Benz C200 CGI, 1796 cc, Automatic</small></p>\r\n', 1478064427, 1478237870, 1, 1),
(3, 4, '0e5f70458925ecb0220867d55d48a9e4.jpg', '<h2><strong>2013 Peugeot 207 SV 1.6 (A) FULL SPEC 1 LADY OWNER</strong></h2>\r\n\r\n<p><small>Peugeot 207, 1597 cc, Automatic</small></p>\r\n', 1478064428, 1478238119, 1, 1),
(4, 6, 'f1fe9b3bd65fc7ed298ab3326e184446.jpg', '<h2><strong>2012 Honda Civic 1.8 (A) SL Full Spec FaceLift</strong></h2>\r\n\r\n<p><small>Honda Civic 1.8 (A) SL, 1799 cc, Automatic</small></p>\r\n', 1478064429, 1478238144, 1, 1),
(5, 1, 'b8fb47b817e38b7a911eff034c9cc48a.jpg', '<h2><strong>2016 Audi Q5.0</strong></h2>\r\n\r\n<p><small>Audi Q5, 2.0L I4, Automatic 4 Speed</small></p>\r\n', 1478064429, 1478238205, 1, 1),
(6, 3, '08c7c032daafaad7df221bb7b9c2cdce.jpg', '<h2><strong>Toyota begins shipping Le Yaris to America</strong></h2>\r\n\r\n<p><small>Toyota yaris, engine test, Automatic 3 Speed</small></p>\r\n', 1478064429, 1478238587, 1, 1);
...
(1, 'admin', '', '$2y$13$ntbLKxf6FVMBWAwwnJwuh.72lY.WKkM7sZJ5OHyCjfIb0bxObHRbW', NULL, 'mrbankshart@gmail.com', 10, 1473411091, 1477636515);
...
ALTER TABLE `car_type`
  ADD PRIMARY KEY (`sub_category_id`,`car_id`,`category_id`),
  ADD KEY `fk_sub_category_has_category_category1_idx` (`category_id`),
  ADD KEY `fk_sub_category_has_category_sub_category1_idx` (`sub_category_id`),
  ADD KEY `fk_sub_category_has_category_car1_idx` (`car_id`);
...
--
-- Indexes for table `category_has_sub_category`
--
ALTER TABLE `category_has_sub_category`
  ADD PRIMARY KEY (`category_id`,`sub_category_id`),
  ADD KEY `fk_category_has_sub_category_sub_category1_idx` (`sub_category_id`),
  ADD KEY `fk_category_has_sub_category_category1_idx` (`category_id`);
...
--
ALTER TABLE `car_type`
  ADD CONSTRAINT `fk_sub_category_has_category_car1` FOREIGN KEY (`car_id`) REFERENCES `car` (`id`) ON DELETE NO ACTION ON UPDATE NO ACTION,
  ADD CONSTRAINT `fk_sub_category_has_category_category1` FOREIGN KEY (`category_id`) REFERENCES `category` (`id`) ON DELETE NO ACTION ON UPDATE NO ACTION,
  ADD CONSTRAINT `fk_sub_category_has_category_sub_category1` FOREIGN KEY (`sub_category_id`) REFERENCES `sub_category` (`id`) ON DELETE NO ACTION ON UPDATE NO ACTION;

--
-- Constraints for table `category_has_sub_category`
--
ALTER TABLE `category_has_sub_category`
  ADD CONSTRAINT `fk_category_has_sub_category_category1` FOREIGN KEY (`category_id`) REFERENCES `category` (`id`) ON DELETE NO ACTION ON UPDATE NO ACTION,
  ADD CONSTRAINT `fk_category_has_sub_category_sub_category1` FOREIGN KEY (`sub_category_id`) REFERENCES `sub_category` (`id`) ON DELETE NO ACTION ON UPDATE NO ACTION;
